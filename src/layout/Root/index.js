                  ...
                  <App>
                    <Switch>
                      ...
                      <Route
                        ...
                        component={getComponentAsync(import(/* webpackChunkName: "E500" */ 'page/StudentList'))}
                      />
                      <Route
                        exact
                        path="/project/food/weeklyrecipe"
                        component={getComponentAsync(import(/* webpackChunkName: "E500" */ 'page/WeeklyRecipe'))}
                      />
                      <Route
                        exact
                        path="/project/food/weeklyrecipeedit"
                        component={getComponentAsync(import(/* webpackChunkName: "E500" */ 'page/WeeklyRecipeEdit'))}
                      />
                      <Route
                        exact
                        path="/project/food/menulistedit"
                        component={getComponentAsync(import(/* webpackChunkName: "E500" */ 'page/MenuListEdit'))}
                      />
